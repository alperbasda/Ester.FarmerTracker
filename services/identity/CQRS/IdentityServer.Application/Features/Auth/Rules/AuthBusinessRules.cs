...
public class AuthBusinessRules : BaseBusinessRules
{
    ...
    public void ThrowUserNotFoundException(User user)
    {
        if(user == null)
        {
            var message = base.TokenParameters.UserLanguage == "TR" ? "Kullanıcı Bulunamadı" : "User Not Found";
    ...
    {
        user.UserScopes = user.UserScopes.Where(w => w.Expiration == null || w.Expiration > DateTime.UtcNow).ToList();
        ...
        if (user.Roles != null && user.Roles.Any())
        {
            ...
            roleScopes.Where(w => w.Expiration == null || w.Expiration > DateTime.UtcNow).Select(w => new UserScope
            {
