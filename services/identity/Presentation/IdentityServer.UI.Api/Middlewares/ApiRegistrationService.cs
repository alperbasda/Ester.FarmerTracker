...
public static class AddApiRegistrationServices
{
    public static IServiceCollection AddApiServices(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        //Şimdilik Databaseloggeri destekleyemiyoruz.
        services.AddTransient<LoggerServiceBase, ElasticLogger>();

        services.AddTransient<IMailTemplateHelper, MailTemplateHelper>();
        services.AddTransient<IMailingService, MailingManager>();
